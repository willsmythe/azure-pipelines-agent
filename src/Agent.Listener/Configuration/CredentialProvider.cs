...
namespace Microsoft.VisualStudio.Services.Agent.Listener.Configuration
{
    ...
    public sealed class AadDeviceCodeAccessToken : CredentialProvider
    {
        ...
        private string _azurePipelineAgentClientId = "2da05afc-592d-416a-93fd-bc0de58d013e";
        ...
        public override VssCredentials GetVssCredentials(IHostContext context)
        {
            ...
            DeviceCodeResult codeResult = ctx.AcquireDeviceCodeAsync(_azureDevOpsResourceId, _azurePipelineAgentClientId).GetAwaiter().GetResult();
